...
# TODO for sgm files uncomment this
...
# TODO for raw text files uncomment this
echo "Tokenizing valid and test data..."
...
#
# Link monolingual validation and test data to parallel data (Warning: para data is very small)
#
